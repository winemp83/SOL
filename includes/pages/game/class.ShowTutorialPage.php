...
if($USER['tut_m7']==0){
if($PLANET['spy_sonde'] >=1 && $USER['spy_tech'] >=2 ){
...
if($USER['tut_m8']==0){
if($PLANET['colonizer'] >=10 && $planet_count >=2 && $PLANET['big_ship_cargo'] >=50){
...
if($USER['tut_m9']==0){
if($PLANET['recycler'] >=25 && $PLANET['battle_ship'] >=100 && $PLANET['energy']>=10000){
