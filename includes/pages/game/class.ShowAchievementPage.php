...

{
	...
	{
		if($PLANET['metal_mine'] >= 60 && $PLANET['crystal_mine'] >= 57 && $PLANET['deuterium_sintetizer'] >=55)
		{
			$GLOBALS['DATABASE']->query("UPDATE ".USERS." SET `achievements_mine` = achievements_mine+1 WHERE `id` = ".$USER['id'].";");
		...
		if($PLANET['crystal_mine'] >=57)
			...
			$mine_done2 = '<img src="styles/achievements/miss.png" >';	
		if($PLANET['deuterium_sintetizer'] >=55)
			$mine_done3 = '<img src="styles/achievements/done.png" >';
		else
			$mine_done3 = '<img src="styles/achievements/miss.png" >';
		...
		$this->tplObj->assign_vars(array(
			...
			'mine_req_3'		=> sprintf($LNG['achievements_mine_require_3'],55),
	...
	if($USER['achievements_battle'] == 1)
	{
		...
		$this->tplObj->assign_vars(array(
			...
			'battle_req_2'		=> sprintf($LNG['achievements_battle_require_2'],45),
	...
	if($USER['achievements_battle'] == 2)
	{
		...
		$this->tplObj->assign_vars(array(
			...
			'battle_req_2'		=> sprintf($LNG['achievements_battle_require_2'],105),
	...
	if($USER['achievements_battle'] == 4)
	{
		...
		$this->tplObj->assign_vars(array(
			...
			'battle_req_2'		=> sprintf($LNG['achievements_battle_require_2'],500),
	...
	if($USER['achievements_battle'] == 5)
	{
		...
		$this->tplObj->assign_vars(array(
			...
			'battle_req_2'		=> sprintf($LNG['achievements_battle_require_2'],1500),
	...
	if($USER['achievements_battle'] == 6)
	{
		...
		$this->tplObj->assign_vars(array(
			...
			'battle_req_2'		=> sprintf($LNG['achievements_battle_require_2'],4500),
	...
	if($USER['achievements_ship'] == 4)
	{
		if($PLANET['lune_noir']>=75)
		{
			...
			$PLANET[$resource[901]]	+= 2000000; //reward
                    $PLANET[$resource[902]]	+= 2000000; //reward
                    $PLANET[$resource[903]]	+= 2000000; //reward
                    $USER[$resource[921]] += 5000; //reward dm
	...
	if($USER['achievements_storage'] == 2)
	{
		...
		$this->tplObj->assign_vars(array(
			...
			'storage_req_3'		=> sprintf($LNG['achievements_storage_require_3'],12),
	...
	if($USER['achievements_storage'] == 3)
	{
		if($PLANET['metal_store'] >= 24 && $PLANET['crystal_store'] >= 22 && $PLANET['deuterium_store'] >= 20)
		{
			...
			$PLANET[$resource[901]]	+= 1000000; //reward
                    ...
                    $USER[$resource[921]] += 0; //reward dm
			$GLOBALS['DATABASE']->query("UPDATE ".USERS." SET `rpg_stockeur` = rpg_stockeur+1 WHERE `id` = ".$USER['id'].";");
		...
		$this->tplObj->assign_vars(array(
			...
			'storage_req_2'		=> sprintf($LNG['achievements_storage_require_2'],22),
			'storage_req_3'		=> sprintf($LNG['achievements_storage_require_3'],20),
	...
	if($USER['achievements_moon'] == 1)
	{
		...
		$this->tplObj->assign_vars(array(
			...
			'moon_req_1'		=> sprintf($LNG['achievements_moon_require_1'],1),
	...
	if($USER['achievements_moon'] == 2)
	{
		...
		$this->tplObj->assign_vars(array(
			...
			'moon_req_1'		=> sprintf($LNG['achievements_moon_require_1'],3),
			'moon_req_2'		=> sprintf($LNG['achievements_moon_require_2'],1),
	...
	if($USER['achievements_moon'] == 3)
	{
		...
		$this->tplObj->assign_vars(array(
			...
			'moon_req_2'		=> sprintf($LNG['achievements_moon_require_2'],2),
			'moon_req_3'		=> sprintf($LNG['achievements_moon_require_3'],1),
	...
	if($USER['achievements_friend'] == 1)
	{
		if($USER['ally_id'] > 0)
		{
			...
			$PLANET[$resource[901]]	+= 1000; //reward
                    ...
                    $PLANET[$resource[903]]	+= 1000; //reward
                    $USER[$resource[921]] += 0; //reward dm
			$this->printMessage(sprintf($LNG['achievements_success'],$LNG['achievements_typ_friend'],$LNG['achievements_friend_lvl1'],$LNG['achievements_friend_reward_lvl1']),"?page=achievement",4);
			exit;	
		}
		if ($USER['ally_id'] > 0)
	...
	if($USER['achievements_friend'] == 2)
	{
		...
		if($query>1)
		{
			...
			$PLANET[$resource[901]]	+= 0; //reward
                    ...
                    $PLANET[$resource[903]]	+= 0; //reward
                    $USER[$resource[921]] += 0; //reward dm
			$this->printMessage(sprintf($LNG['achievements_success'],$LNG['achievements_typ_friend'],$LNG['achievements_friend_lvl2'],$LNG['achievements_friend_reward_lvl2']),"?page=achievement",4);
			exit;	
		}
		if ($query>1)
			$friend_done1 = '<img src="styles/achievements/done.png" >';
	...
	if($USER['achievements_friend'] > 2)
	{
		...
		$this->tplObj->assign_vars(array(
			'friend_lvl'		=> ' <span style="color:lime">'.$LNG['achievements_friend_done'].'</span>',
			'friend_req_1'		=> $LNG['achievements_friend_lvl2_require_1'],
			'friend_reward'		=> $LNG['achievements_friend_reward_lvl2'],
			'friend_done1'    	=> $friend_done1,
	...
	if($USER['achievements_debris'] == 1)
	{
		...
		$this->tplObj->assign_vars(array(
			...
			'debris_req_1'		=> sprintf($LNG['achievements_debris_require_1'],10000),
			'debris_req_2'		=> sprintf($LNG['achievements_debris_require_2'],10000),
	...
	if($USER['achievements_debris'] == 2)
	{
		...
		$this->tplObj->assign_vars(array(
			...
			'debris_req_1'		=> sprintf($LNG['achievements_debris_require_1'],100000),
			'debris_req_2'		=> sprintf($LNG['achievements_debris_require_2'],100000),
	...
	if($USER['achievements_debris'] == 3)
	{
		...
		if ($USER['kbmetal'] >=1000000)
			$debris_done1 = '<img src="styles/achievements/done.png" >';
		else
			$debris_done1 = '<img src="styles/achievements/miss.png" >';
		if($USER['kbcrystal'] >=1000000)
			$debris_done2 = '<img src="styles/achievements/done.png" >';
		else
			$debris_done2 = '<img src="styles/achievements/miss.png" >';	
		...
		$this->tplObj->assign_vars(array(
			...
			'debris_req_1'		=> sprintf($LNG['achievements_debris_require_1'],1000000),
			'debris_req_2'		=> sprintf($LNG['achievements_debris_require_2'],1000000),
