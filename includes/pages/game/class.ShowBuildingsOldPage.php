 ...
 * @info $Id: class.ShowBuildingsPage.php 2574 2013-01-12 15:41:54Z slaver7 $
 * @link http://2moons.cc/
 */

class ShowBuildingsoldPage extends AbstractPage
{	
	...
	public function show()
	{
		...
		if(!empty($TheCommand) && $_SERVER['REQUEST_METHOD'] === 'POST' && $USER['urlaubs_modus'] == 0)
		{
			...
			$this->redirectTo('game.php?page=buildingsOld');
		}
		...
		$this->display('page.buildings.old.default.tpl');
