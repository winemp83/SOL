	...
	function buyModul(){
		...
		if($USER['ally_id'] != 0){
			...
			$this->tplObj->assign_vars(array(
				...
				'one_m'			=> pretty_number($price_one_m)." Metall <br/>",
				'one_k'			=> pretty_number($price_one_k)." Kristall <br/>",
				'one_d'			=> pretty_number($price_one_d)." Deuterium",
				'two_akt'		=> $two_h,
				'two_max'		=> $this->Produ_max,
				'two_m'			=> pretty_number($price_two_m)." Metall <br/>",
				'two_k'			=> pretty_number($price_two_k)." Kristall <br/>",
				'two_d'			=> pretty_number($price_two_d)." Deuterium",
				'tree_akt'		=> $tree_h,
				'tree_max'		=> $this->Build_max,
				'tree_m'		=> pretty_number($price_tree_m)." Metall <br/>",
				'tree_k'		=> pretty_number($price_tree_k)." Kristall <br/>",
				'tree_d'		=> pretty_number($price_tree_d)." Deuterium",
				'four_akt'		=> $four_h,
				'four_max'		=> $this->Reser_max,
				'four_m'		=> pretty_number($price_four_m)." Metall <br/>",
				'four_k'		=> pretty_number($price_four_k)." Kristall <br/>",
				'four_d'		=> pretty_number($price_four_d)." Deuterium",
				'five_akt'		=> $five_h,
				'five_max'		=> $this->Defen_max,
				'five_m'		=> pretty_number($price_five_m)." Metall <br/>",
				'five_k'		=> pretty_number($price_five_k)." Kristall <br/>",
				'five_d'		=> pretty_number($price_five_d)." Deuterium",
				'six_akt'		=> $six_h,
				'six_max'		=> $this->Attak_max,
				'six_m'			=> pretty_number($price_six_m)." Metall <br/>",
				'six_k'			=> pretty_number($price_six_k)." Kristall <br/>",
				'six_d'			=> pretty_number($price_six_d)." Deuterium",
				'seven_akt'		=> $seven_h,
				'seven_max'		=> $this->Topics_max,
				'seven_m'		=> pretty_number($price_seven_m)." Metall <br/>",
				'seven_k'		=> pretty_number($price_seven_k)." Kristall <br/>",
				'seven_d'		=> pretty_number($price_seven_d)." Deuterium",
				'deakt_one'		=> $deak_1,
				'deakt_two'		=> $deak_2,
				'deakt_tree'	=> $deak_3,
				'deakt_four'	=> $deak_4,
