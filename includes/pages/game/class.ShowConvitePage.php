...
class ShowConvitePage extends AbstractPage 
{
	function __construct() 
	{
       ...
       // Yazdir gelsin
         ...
         $Message = '<center>Der Gründer der Allianz <font color=red>'.$ally['ally_name'].'</font><br><br>Lädt dich ein, seiner Allianz beizutreten<br><a href="game.php?page=alliance&mode=apply&allyid='.$USER['ally_id'].'"><font color=#00FF00>Klicke Hier um der Allianz bei zutretten </font></a></center>';
         $summery=0;   
         }
