...
class StatBanner {
	...
	public function CreateUTF8Banner($data) {
		...
		imagettftext($image, 11, 0, 20, 81, $shadow, $Font, $LNG['ub_points'].': '.html_entity_decode($data['total_points']));
		imagettftext($image, 11, 0, 20, 80, $color, $Font, $LNG['ub_points'].': '.html_entity_decode($data['total_points']));
