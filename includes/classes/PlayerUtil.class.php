...
class PlayerUtil {
	...
	static function createPlayer($Universe, $UserName, $UserPass, $UserMail, $UserLang = NULL, $race, $Galaxy = NULL, $System = NULL, $Position = NULL, $planetname = NULL, $authlevel = 0, $UserIP = NULL)
	{
