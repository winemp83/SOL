...
{* TF-Event-Mod *} 
<tr>
    <td>{$ev_eventplaneten}</td>
    <td><input name="tfev_aktiv"{if $tfev_aktiv} checked="checked"{/if} type="checkbox"></td>
    <td>&nbsp;</td>
</tr> 
<tr>
    <td>{$tf_info_ev}</td>
    <td><input name="tfev_info" size="120" maxlength="128" value="{$tfev_info}" type="text"></td>
    <td>&nbsp;</td>
</tr>
{* TF-Event-Mod / Ende *} 
<tr>
