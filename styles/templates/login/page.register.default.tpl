...
<input type="hidden" value="{$referralData.id}" name="referralID">
	...
	<div class="rowForm">
		...
		<select name="race" id="race">
			<option value="2" selected>Mensch</option>
			<option value="1">Klingone</option>
			<option value="3">Vulkanier</option>
			<option value="4">Ferengi</option>
		</select>
		<table>
		<tr><th>Rasse:</th><th>Bonus:</th></tr>
		<tr><td>Mensch</td><td>Verteidigungsbauzeit 80%</td></tr>
		<tr><td>Klingone</td><td>Flottenbauzeit 80%</td></tr>
		<tr><td>Vulkanier</td><td>Forschungszeit 80%</td></tr>
		<tr><td>Ferengi</td><td>Gebäudebauzeit 80%</td></tr>
		</table>
	</div>
