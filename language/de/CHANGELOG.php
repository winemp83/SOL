...
'v1.7.4.1.2 Custom' => 'winemp83 03.08.2013
-modify Menue, Menue zuordnung übersichtlicher gestaltet.
-lng, Rechtschreibfehler entfernt.
+neue Grafiken eingefügt.
+vorbereitung zum Umzug auf den Live-Server.
+Foren Avatare auf den Live-Server hinzugefügt',
'v1.7.4.1.2 Custom' => 'winemp83 22.07.2013
+add MOD Daily Quest vorbereitet.
+add MOD Custom Race vorbereitet.
+add Alte Galaxy Ansicht eingefügt.
-- Balancing änderungen an den Custom Mods.
-- Gutschein Mod gefixxt sollte nun die Richtige anzahl an Ressourcen geben.
-- Tutorial gefixxt und angepasst',
'v1.7.4.1.1 Custom' => 'Darkman 12.07.2013
--Fix Chat: Chat sollte wieder Funktionieren',
'v1.7.4.1 Custom' => 'winep83 11.07.2013
-add new Gutscheinmod: Neuer Gutschein Mod der es erlaubt auch das Gutscheine verschenkt werden können.
-add Gutschein Shop: Absofort können Gutscheine gegen DM gekauft werden der Preis liegt atm bei 500 Dunkle Materie wird aber noch mal zwecks Balancing angepasst.
-add ADM new Gutscheinmod: Administrative Oberfläche eingespielt.
-@TODO : Noch Ideen Sammeln was wir/ihr noch an Mods euch wünscht!
-@TODO : Wahrscheinlich nehm ich heute nacht das Spiel für 1-2 Std vom Netz um den Chat zufixxen.
-@TODO : Dringent suche ich ein neues Team und mehr Tester! Bitte meldet euch wenn ihr Lust habt. 
MfG: winemp83',
'v1.7.4 Custom' => 'winemp83 10.07.2013
-add GutscheinMod: Absofort können gutscheine ausgestellt werden von den Administratoren, diese Können dann via $key verfahren eingelöst werden.
-Facebook: Werbung und Link zum Test-Server bei Facebook eingestellt.
-Administrative änderungen: Sobald diese Source in den Produktiv betrieb wechselt wird winemp83 nicht mehr als Administrator zur verfügung stehen er wechselt aus Zeit gründne zu den Scripten mit erweiterten Rechten.
 Wer dann seinen Posten übernimmt steht noch nicht fest.
-Layout: Es wird weiterhin nach einen neuen Layout fürs Spiel gesucht sollte wer einen Idee oder gar Fertiges Template haben meldet euch bitte ei Darkman oder winemp83',
'v1.7.3 Custom' => 'winemp83 09.07.2013
-add Marktplatz: Custom Mod Marktplatz eingespielt und angepasst.
-add Rassen: Custom Mod Race eingespielt und in der RegistrySeite eingefügt, Folgende Rassen stehen zur Auswahl:
	Mensch:    Verteidigungs Bauzeit verkürzt
	Vulkanier: Forschungszeit verkürzt
	Klingonen: Flotten Bauzeit verkürzt
	Ferengi:   Bauzeit verkürzt
-add GutscheinMod: vorbereitet allerdings muss noch einiges umgeschrieben werden!
-add Angriffs Warner: Custom Mod eingespielt 
',
