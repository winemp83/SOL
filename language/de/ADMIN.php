 ...
 * @info $Id: ADMIN.php 2604 2013-01-18 11:35:42Z slaver7 $
 * @link http://2moons.cc/
 */
...
$LNG['mod_gutschein_exists_minerals']			= 'Metall';
$LNG['mod_gutschein_exists_kristall']			= 'Kristall';
$LNG['mod_gutschein_exists_deuterium']			= 'Deuterium';
$LNG['mod_gutschein_exists_dm']					= 'Dunkle Materie';
$LNG['mod_gutschein_exists_key']				= 'Gutscheincode';
$LNG['mod_gutschein_exists_used']				= 'erstellt von';
$LNG['mod_gutschein_exists_delete']				= 'Löschen';
...
$LNG['mod_gutscheine_gutschrift_minerals']		= 'Gutschrift Metall';
$LNG['mod_gutscheine_gutschrift_kristall']		= 'Gutschrift Kristall';
...
$LNG['ev_name']       				        =    'Planetenname';
$LNG['ev_eventplaneten'] 				    =    'Spezial-Event';
$LNG['ev_user_id']                          =    'Benutzer-ID';
$LNG['ev_planet_anzahl']   				    =    'Anzahl-Planeten';
$LNG['ev_position_von']                     =    'Position Von ';
$LNG['ev_position_bis']                     =    'Position Bis ';
$LNG['ev_ress_von']                         =    'Rohstoffe Von ';
$LNG['ev_ress_bis']                         =    'Rohstoffe Bis ';
$LNG['ev_eventplanet']                      =    'Spezial-Event'; 
$LNG['ev_verteidigung']						=    'Verteidigung';
$LNG['ev_schiffe']					    	=    'Schiffe';
$LNG['ev_angriff']					    	=    'Angriff';
$LNG['ev_planetdata']					   	=    'Planetendaten';
$LNG['ev_anzplanet']					   	=    'Anzahl EV - Planeten  ';
$LNG['ev_anzevtf']			    		   	=    'Anzahl EV - Trümmerf.';
$LNG['ev_start']					    	=    'EV-Planeten anlegen';
$LNG['ev_delempty']					    	=    'LEERE Planeten löschen';
$LNG['ev_delall']					    	=    'ALLE  Planeten  löschen';
$LNG['ev_evplanet']					    	=    'Planeten-EVENT';
$LNG['ev_tfplanet']					    	=    'Trümmerfeld-EVENT';
$LNG['ev_attack']					    	=    'Gegenangriff-EVENT';
$LNG['ev_info']					        	=    'EVENT-Info-Text';
$LNG['ev_erro1']					       	=    'ERROR!! Planeten wurden NICHT angelegt!<br>Bitte Planeten- oder TF-Event auswählen!';
$LNG['ev_erro2']					       	=    'ERROR!! Planeten wurden NICHT angelegt!<br>Bitte Überprüfen sie Ihre Planetendaten!';
$LNG['ev_erro3']					       	=    'Die eingetragene Benutzer-ID existiert nicht!<br>Bitte überprüfen!';
$LNG['ev_del_info']					       	=    'Es wurden alle Event-Planeten gelöscht!';
$LNG['ev_del_info2']				       	=    'Es wurden leere TF-Planeten gelöscht!';
$LNG['ev_msg_mail1']					  	=	 'Es wurden %s Event-Planeten und Trümmerfelder erstellt!<br>Die Spieler wurden benachrichtigt!';
$LNG['ev_msg_mail2']					   	=	 'Es wurden %s Event-Planeten erstellt!<br>Die Spieler wurden benachrichtigt!';
$LNG['ev_msg_mail3']					   	=	 'Es wurden %s Trümmerfelder erstellt!<br>Die Spieler wurden benachrichtigt!';
$LNG['ev_subject_pl_tf']			       	=    'Neuer Planeten- und Trümmerfeld-Event gestartet!';
$LNG['ev_subject_pl']			        	=    'Neuer Planeten-Event gestartet!';
$LNG['ev_subject_tf']			        	=    'Neuer Trümmerfeld-Event gestartet!';
$LNG['ev_msg_pl_tf']				       	=    'Mitteilung an den Captain!<br>Unsere Galaxie wurde von dem Piraten %s überfallen!<br>%s Planeten wurden von ihm in einer gewaltigen Schlacht erobert, in der unzählige Trümmerfelder entstanden sind.<br>Dir bietet sich jetzt die Möglichkeit Ruhm und Reichtum zu erlangen!<br><U>Dein Auftrag:</U><br>Erobere Planeten, baue Trümmerfelder ab, aber Vorsicht, die Piraten werden sich vermutlich nicht kampflos ergeben.<br>Die eroberten Planeten befinden sich zwischen den Koordinaten %s-%s-%s und  %s-%s-%s !<br>Das Raumflottenkommando wünscht dir viel Erfolg.';
$LNG['ev_msg_pl']					       	=    'Mitteilung an den Captain!<br>Unsere Galaxie wurde von dem Piraten %s überfallen!<br>%s Planeten wurden von ihm in einer gewaltigen Schlacht.<br>Dir bietet sich jetzt die Möglichkeit Ruhm und Reichtum zu erlangen!<br><U>Dein Auftrag:</U><br>Erobere die Planeten!<br>Aber Vorsicht, die Piraten werden sich vermutlich nicht kampflos ergeben.<br>Die eroberten Planeten befinden sich zwischen den Koordinaten %s-%s-%s und  %s-%s-%s !<br>Das Raumflottenkommando wünscht dir viel Erfolg.';
$LNG['ev_msg_pl']			 		       	=    'Neuer Planeten-Event gestartet!';
$LNG['ev_msg_tf']				        	=    'Mitteilung an den Captain!<br>Unsere Aufklärer haben die Entstehung einer Supernova gemeldet!<br>Dadurch wurden unzählige Planeten vernichtet!<br>Zwischen den Koordinaten %s-%s-%s und  %s-%s-%s befinden sich jetzt ca. %s Trümmerfelder die darauf warten abgebaut zu werden!<br>Das Raumflottenkommando wünscht dir viel Erfolg.';
$LNG['ev_attackinfo']						=	 'Wahrscheinlichkeit';
$LNG['ev_attackinfo_msg']					=	 'e-Mail beim Angriff';
$LNG['tf_info_ev']					        =    'Trümmerfeld-Infotext'; 