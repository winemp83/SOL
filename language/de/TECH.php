...
$LNG['shortDescription'] = array(
	...
	3 => 'Entziehe dem Wasser eines Planeten den geringen Deuteriumanteil.',
	5 => 'Die Bank erlaubt es Ressourcen zu speichern, jede Einzahlung kostet 5% der Ressourcen die man speichern will. Auszahlen kostet keinen Betrag! Jede stufe erhöht die Lager Kapazitäten',
	...
	22 => 'Lagerstätte für unbearbeitete Metallerze bevor sie weiterverarbeitet werden.',
	23 => 'Lagerstätte für unbearbeitetes Kristall bevor es weiterverarbeitet wird.',
	...
	44 => 'Raketensilos dienen zum Einlagern von Raketen. Pro Stufe Erhöht sich die reichweite um 1 System nach oben und unten. Beispiel: Main Planet 1/2/10 um 1/6/10 zu hatten brauch ich Raketens lvl 4',
	...
	124 => 'Auch ohne das Erforschen von Astrophysik ist es möglich zu den Hauptplaneten noch 2 Kolonien zu haben. Aber es führt zu dem Problem dass man nicht jeden Planeten besiedelnd kann. Um weitere Kolonien zu besiedeln, muss man Astrophysik erfoschen - den nächsten Planet bekomm man mit Astrop. 1 dann geht es weiter mit 3, 5, 7, 9 usw..... Dadurch werden weite Expeditionsreisen in noch unerforschte Gebiete möglich.',
	...
	207 => 'Schlachtschiffe bilden meist das Rückrad einer Flotte. Ihre schweren Geschütze, die hohe Geschwindigkeit und der große Frachtraum machen sie zu ernst zunehmenden Gegnern.',
	...
	216 => 'Der Nachfolger des beliebten Todessterns, nur etwas schneller und stärker.',
	217 => 'Ist der eine Weiterentwicklung des großen Transporters. Er hat mehr Ladevermögen und fliegt schneller.',
	218 => 'Die Superlative schlechthin, allerdings sehr langsam.',
	...
	410 => 'Nach jahrelangem Forschen an der Gravitationskraft ist es Wissenschaftlern gelungen, eine Gravitonkanone zu entwickeln, die kleine konzentrierte Gravitationsfelder erzeugen kann und sie auf die Gegner schießen lässt.',
	...
	601 => 'Der Geologe ist ein Experte der Gesteinsphysiologie und der Kristallographie. Mit seinem Expertenteam bestehend aus Metall-Ingenieuren und Chemikern, assistiert er den interplanetaren Regierungen in der Recherche nach neuen Quellen und diese sicher gewinnen zu können.',
	...
	613 => 'Der General ist eine ehrwürdige Person, der seit vielen Jahren in der Armee dient. Durch unzählige Manöver hat der General Strategien entwickelt, um die Flottengeschwindigkeiten in sämtlichen Konstellationen verschiedenster Schiffstypen zu optimieren.',
...
$LNG['longDescription'] = array(
	...
	2 => 'Baut Mineralien ab, die für die Feinelektronik benötigt werden. Sie benötigt jedoch mehr Energie, da sie die Mineralien gleich in nötige Legierungen verarbeitet.',
	...
	22 => 'Riesige Lagerstätte für abgebautes Metallerz. Je größer der Speicher, desto mehr Metall kann darin gelagert werden. Ist das Lager voll, wird kein Metall mehr abgebaut.',
	...
	118 => 'Durch eine Raumzeitverkrümmung wird in unmittelbarer Umgebung eines Schiffes der Raum komprimiert, womit sich weite Strecken sehr schnell zurücklegen lassen. Je höher der Hyperraumantrieb entwickelt ist, desto höher wird die Kompression des Raumes, wodurch sich pro Stufe die Geschwindigkeit der Schiffe die damit ausgestattet sind (Schlachtkreuzer, Schlachtschiffe, Zerstörer und Todessterne) um 30% erhöht.',
	120 => 'Laser (Lichtverstärkung durch induzierte Strahlungsemission) erzeugen einen intensiven, energiereichen Strahl von kohärentem Licht. Diese Geräte finden in allen möglichen Bereichen ihre Anwendung. Von optischen Computern bis hin zu schweren Laserwaffen, die mühelos durch Raumschiffpanzerungen schneiden. Die Lasertechnik bildet einen wichtigen Grundstein für die Erforschung weiterer Waffentechnologien.',
	...
	123 => 'Forscher verschiedener Planeten kommunizieren über dieses Netzwerk miteinander. Pro erforschtes Level, wird ein Forschungslabor vernetzt. Dabei werden immer die Labore der höchsten Stufe dazugeschaltet. Das vernetzte Labor muss ausreichend ausgebaut sein um die anstehende Forschung selbständig durchführen zu können. Die Ausbaustufen aller beteiligten Labore werden im intergalaktischen Forschungsnetzwerk zusammen gezählt.',
	124 => 'Die Ersten beiden Kolo´s benötigen keine Astrophysik, aber die planeten Temperatur spielt eine große rolle ohne. Es kann zu fehlschlägen führen.Weitere Erkenntnisse in der Astrophysik ermöglichen den Bau von Laboren, mit denen immer mehr Schiffe ausgestattet werden können. Dadurch werden weite Expeditionsreisen in noch unerforschte Gebiete möglich. Zudem erlauben die Fortschritte die weitere Kolonisation des Weltraumes. Um weitere Planeten zu bekommen, muss man Astrophysik erfoschen - den nächsten Planet bekomm man mit Astrop. 1 dann geht es weiter mit 3, 5, 7, 9 usw....',
	131 => 'Erhöht die Produktion der Metallmine um 2%',
	132 => 'Erhöht die Produktion der Kristallmine um 2%',
	133 => 'Erhöht die Produktion der Deuteriumsynthetisierer um 2%',
	199 => 'Ein Graviton ist ein Partikel, das keine Masse und keine Ladung besitzt, welche die Gravitationskraft bestimmt. Durch Abschuss einer konzentrierten Ladung von Gravitonen kann ein künstliches Gravitationsfeld errichtet werden, welches ähnlich einem schwarzen Loch, Masse in sich hineinzieht, wodurch Schiffe oder auch Monde vernichtet werden können. Um eine ausreichende Menge Gravitonen herzustellen benötigt es riesige Mengen an Energie.',
	...
	216 => 'Dieses monströse Schiff ist eine Weiterentwicklung des Todessternes, die an Geschwindigkeit zugenommen, jedoch an Stärke verloren hat.	',
	...
	219 => 'Dieses Schiff ist eine wahrhaft gigantische Recyclinganlage im Weltraum mit atemberaubender Geschwindigkeit und riesigem Lagerraum! Geschaffen für große Imperien.',
	220 => 'Mit diesem Schiff ist es nach jahrelangem Forschen möglich, Dunkle Materie an seinem Mond zu sammeln.',
	...
	411 => 'Diese Plattform, mit gigantischem Ausmaß, ist das Größte was das Universum je gesehen hat. Es ist eine unbewegliche defensive Plattform. Sie besitzt keinen direkten Antrieb und wird durch Gravitonforschung in einer stabilen Umlaufbahn des Planeten gehalten. Das Starten dieses Vorgangs erfordert hohe Mengen an Energie. Die Forscher arbeiten an einer Möglichkeit, auf dieser Plattform Schiffe zu bauen, um sie als einen äusseren Verteidigungsring zu nutzen, der es dem Gegner erschwert zur Planetaren Verteidigung durchzubrechen. Durch das gigantische Ausmaß ist es nur möglich einer dieser Monster zu besitzen.',
	502 => 'Abfangraketen zerstören angreifende Interplanetarraketen. Jede Bodenluftrakete zerstört eine Interplanetarrakete.',
	503 => 'Interplanetarraketen zerstören die gegnerische Verteidigung, können allerdings durch Abfangraketen zerstört werden! Von Interplanetarraketen zerstörte Verteidigungsanlagen bauen sich nicht wieder auf.',
	...
	608 => 'Der Verteidigungsminister ist Mitglied der imperialen Armee. Sein Elan und Ehrgeiz ermöglichen es, jede Kolonie in Rekordzeit zu einen stark befestigtem Stützpunkt auszubauen.',
	609 => 'Der Bunker sah die beeindruckende Arbeit, die Sie in seinem Königreich gefertigt haben. Um Ihnen zu danken, eröffnet er Ihnen die Chance Bunker zu werden. Der Bunker ist die höchste Auszeichnung der Lagerstättenbranche der Imperialen Armee.',
	610 => 'Der Spion ist eine rätselhafte Person. Niemand kennt sein wirkliches Gesicht, und noch weniger weiß jemand ob er schon tot ist.',
	611 => 'Der Commander der imperialen Armee ist Meister im Umgang mit der Flotte. Seine jahrelangen Erfahrungen mit Flotten, mit vielen strategischen Einsätzen, sind eine Bereicherung für jeden Herrscher.',
	612 => 'Der Zerstörer ist ein Offizier ohne Mitleid. Er hat Planeten nur zum Vergnügen dem Erdboden gleich gemacht. Er entdeckt momentan eine neue Methode um Massenvernichtungswaffen herzustellen.',
	613 => 'Der General ist eine ehrwürdige Person, der seit vielen Jahren in der Armee dient. Durch unzählige Manöver hat der General Strategien entwickelt, um die Flottengeschwindigkeiten in sämtlichen Konstellationen verschiedenster Schiffstypen zu optimieren.',
	614 => 'Der Imperator bemerkte bei Ihnen die unleugbaren Qualitäten des Eroberns. Er schlägt Ihnen vor Eroberer zu werden. Der Eroberer ist der höchsten Grad der Ausbildung der imperialen Armee.',
	615 => 'Sie haben gezeigt, dass Sie der größte Eroberer des Universums sind. Es ist Ihrer, solange Sie diesen Platz halten, den Sie bekommen haben.',
