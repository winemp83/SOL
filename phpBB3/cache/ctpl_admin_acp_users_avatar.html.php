<?php if (!defined('IN_PHPBB')) exit; ?><form id="avatar_settings" method="post" action="<?php echo (isset($this->_rootref['U_ACTION'])) ? $this->_rootref['U_ACTION'] : ''; ?>"<?php if ($this->_rootref['S_CAN_UPLOAD']) {  ?> enctype="multipart/form-data"<?php } ?>>
	...
	<?php if (! $this->_rootref['S_IN_AVATAR_GALLERY']) {  if ($this->_rootref['S_UPLOAD_FILE']) {  ?>
		...
		<?php } if ($this->_rootref['S_REMOTE_UPLOAD']) {  ?>
		...
		<?php } if ($this->_rootref['S_ALLOW_REMOTE']) {  ?>
			...
			<dl>
				...
				<dd><input name="width" type="text" id="width" size="3" value="<?php echo (isset($this->_rootref['USER_AVATAR_WIDTH'])) ? $this->_rootref['USER_AVATAR_WIDTH'] : ''; ?>" /> <span><?php echo ((isset($this->_rootref['L_PIXEL'])) ? $this->_rootref['L_PIXEL'] : ((isset($user->lang['PIXEL'])) ? $user->lang['PIXEL'] : '{ PIXEL }')); ?> &times; </span> <input type="text" name="height" size="3" value="<?php echo (isset($this->_rootref['USER_AVATAR_HEIGHT'])) ? $this->_rootref['USER_AVATAR_HEIGHT'] : ''; ?>" /> <span><?php echo ((isset($this->_rootref['L_PIXEL'])) ? $this->_rootref['L_PIXEL'] : ((isset($user->lang['PIXEL'])) ? $user->lang['PIXEL'] : '{ PIXEL }')); ?></span></dd>
			</dl>
