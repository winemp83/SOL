	...
	<div id="topicreview">
		...
		<div class="post <?php if (($_postrow_val['S_ROW_COUNT'] & 1)  ) {  ?>bg1<?php } else { ?>bg2<?php } ?>">
			...
			<div class="postbody" id="pr<?php echo $_postrow_val['POST_ID']; ?>">
				<ul class="profile-icons"><li class="info-icon"><a href="<?php echo $_postrow_val['U_POST_DETAILS']; ?>" title="<?php echo ((isset($this->_rootref['L_POST_DETAILS'])) ? $this->_rootref['L_POST_DETAILS'] : ((isset($user->lang['POST_DETAILS'])) ? $user->lang['POST_DETAILS'] : '{ POST_DETAILS }')); ?>"><span><?php echo ((isset($this->_rootref['L_POST_DETAILS'])) ? $this->_rootref['L_POST_DETAILS'] : ((isset($user->lang['POST_DETAILS'])) ? $user->lang['POST_DETAILS'] : '{ POST_DETAILS }')); ?></span></a></li><li><label for="post_id_list_select_<?php echo $_postrow_val['POST_ID']; ?>"><?php echo ((isset($this->_rootref['L_SELECT'])) ? $this->_rootref['L_SELECT'] : ((isset($user->lang['SELECT'])) ? $user->lang['SELECT'] : '{ SELECT }')); ?>: <input type="checkbox" id="post_id_list_select_<?php echo $_postrow_val['POST_ID']; ?>" name="post_id_list[]" value="<?php echo $_postrow_val['POST_ID']; ?>"<?php if ($_postrow_val['S_CHECKED']) {  ?> checked="checked"<?php } ?> /></label></li></ul>
