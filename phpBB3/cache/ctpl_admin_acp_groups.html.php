...
<?php if ($this->_rootref['S_EDIT']) {  ?>
	...
	<fieldset>
		<legend><?php echo ((isset($this->_rootref['L_GROUP_OPTIONS_SAVE'])) ? $this->_rootref['L_GROUP_OPTIONS_SAVE'] : ((isset($user->lang['GROUP_OPTIONS_SAVE'])) ? $user->lang['GROUP_OPTIONS_SAVE'] : '{ GROUP_OPTIONS_SAVE }')); ?></legend>
	...
	<dl>
		...
		<dd><input name="group_founder_manage" type="checkbox" value="1" class="radio" id="group_founder_manage"<?php echo (isset($this->_rootref['GROUP_FOUNDER_MANAGE'])) ? $this->_rootref['GROUP_FOUNDER_MANAGE'] : ''; ?> /></dd>
	</dl>
	<?php } ?>

	<dl>
		<dt><label for="group_skip_auth"><?php echo ((isset($this->_rootref['L_GROUP_SKIP_AUTH'])) ? $this->_rootref['L_GROUP_SKIP_AUTH'] : ((isset($user->lang['GROUP_SKIP_AUTH'])) ? $user->lang['GROUP_SKIP_AUTH'] : '{ GROUP_SKIP_AUTH }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_GROUP_SKIP_AUTH_EXPLAIN'])) ? $this->_rootref['L_GROUP_SKIP_AUTH_EXPLAIN'] : ((isset($user->lang['GROUP_SKIP_AUTH_EXPLAIN'])) ? $user->lang['GROUP_SKIP_AUTH_EXPLAIN'] : '{ GROUP_SKIP_AUTH_EXPLAIN }')); ?></span></dt>
		<dd><input name="group_skip_auth" type="checkbox" value="1" class="radio" id="group_skip_auth"<?php echo (isset($this->_rootref['GROUP_SKIP_AUTH'])) ? $this->_rootref['GROUP_SKIP_AUTH'] : ''; ?> /></dd>
	</dl>
	<dl>
		...
		<dd><input name="group_legend" type="checkbox" value="1" class="radio" id="group_legend"<?php echo (isset($this->_rootref['GROUP_LEGEND'])) ? $this->_rootref['GROUP_LEGEND'] : ''; ?> /></dd>
	</dl>
	<dl>
		...
		<dd><input name="group_receive_pm" type="checkbox" value="1" class="radio" id="group_receive_pm"<?php echo (isset($this->_rootref['GROUP_RECEIVE_PM'])) ? $this->_rootref['GROUP_RECEIVE_PM'] : ''; ?> /></dd>
	</dl>
	</fieldset>
	...
	<dl>
		<dt><label for="group_max_recipients"><?php echo ((isset($this->_rootref['L_GROUP_MAX_RECIPIENTS'])) ? $this->_rootref['L_GROUP_MAX_RECIPIENTS'] : ((isset($user->lang['GROUP_MAX_RECIPIENTS'])) ? $user->lang['GROUP_MAX_RECIPIENTS'] : '{ GROUP_MAX_RECIPIENTS }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_GROUP_MAX_RECIPIENTS_EXPLAIN'])) ? $this->_rootref['L_GROUP_MAX_RECIPIENTS_EXPLAIN'] : ((isset($user->lang['GROUP_MAX_RECIPIENTS_EXPLAIN'])) ? $user->lang['GROUP_MAX_RECIPIENTS_EXPLAIN'] : '{ GROUP_MAX_RECIPIENTS_EXPLAIN }')); ?></span></dt>
		<dd><input name="group_max_recipients" type="text" id="group_max_recipients" maxlength="10" size="4" value="<?php echo (isset($this->_rootref['GROUP_MAX_RECIPIENTS'])) ? $this->_rootref['GROUP_MAX_RECIPIENTS'] : ''; ?>" /></dd>
	</dl>
	<dl>
		...
		<dd><input name="group_colour" type="text" id="group_colour" value="<?php echo (isset($this->_rootref['GROUP_COLOUR'])) ? $this->_rootref['GROUP_COLOUR'] : ''; ?>" size="6" maxlength="6" /><?php if ($this->_rootref['GROUP_COLOUR']) {  ?>&nbsp;<span style="background-color: #<?php echo (isset($this->_rootref['GROUP_COLOUR'])) ? $this->_rootref['GROUP_COLOUR'] : ''; ?>">&nbsp; &nbsp;</span><?php } ?>&nbsp;&nbsp;<span>[ <a href="<?php echo (isset($this->_rootref['U_SWATCH'])) ? $this->_rootref['U_SWATCH'] : ''; ?>" onclick="popup(this.href, 636, 150, '_swatch'); return false"><?php echo ((isset($this->_rootref['L_COLOUR_SWATCH'])) ? $this->_rootref['L_COLOUR_SWATCH'] : ((isset($user->lang['COLOUR_SWATCH'])) ? $user->lang['COLOUR_SWATCH'] : '{ COLOUR_SWATCH }')); ?></a> ]</span></dd>
	</dl>
	<dl>
	...
	<?php if (! $this->_rootref['S_IN_AVATAR_GALLERY']) {  if ($this->_rootref['S_CAN_UPLOAD']) {  ?>
		...
		<dl>
			...
			<dd><input name="width" type="text" id="width" size="3" value="<?php echo (isset($this->_rootref['AVATAR_WIDTH'])) ? $this->_rootref['AVATAR_WIDTH'] : ''; ?>" /> <span><?php echo ((isset($this->_rootref['L_PIXEL'])) ? $this->_rootref['L_PIXEL'] : ((isset($user->lang['PIXEL'])) ? $user->lang['PIXEL'] : '{ PIXEL }')); ?> &times; </span> <input type="text" name="height" size="3" value="<?php echo (isset($this->_rootref['AVATAR_HEIGHT'])) ? $this->_rootref['AVATAR_HEIGHT'] : ''; ?>" /> <span><?php echo ((isset($this->_rootref['L_PIXEL'])) ? $this->_rootref['L_PIXEL'] : ((isset($user->lang['PIXEL'])) ? $user->lang['PIXEL'] : '{ PIXEL }')); ?></span></dd>
		</dl>
...
<?php } else if ($this->_rootref['S_LIST']) {  ?>
	...
	<?php $_leader_count = (isset($this->_tpldata['leader'])) ? sizeof($this->_tpldata['leader']) : 0;if ($_leader_count) {for ($_leader_i = 0; $_leader_i < $_leader_count; ++$_leader_i){$_leader_val = &$this->_tpldata['leader'][$_leader_i]; if (!($_leader_val['S_ROW_COUNT'] & 1)  ) {  ?><tr class="row1"><?php } else { ?><tr class="row2"><?php } ?>
			...
			<td><?php if ($_leader_val['USERNAME_COLOUR']) {  ?><a href="<?php echo $_leader_val['U_USER_EDIT']; ?>" style="color: #<?php echo $_leader_val['USERNAME_COLOUR']; ?>;" class="username-coloured"><?php echo $_leader_val['USERNAME']; ?></a><?php } else { ?><a href="<?php echo $_leader_val['U_USER_EDIT']; ?>"><?php echo $_leader_val['USERNAME']; ?></a><?php } ?></td>
	...
	<?php $_member_count = (isset($this->_tpldata['member'])) ? sizeof($this->_tpldata['member']) : 0;if ($_member_count) {for ($_member_i = 0; $_member_i < $_member_count; ++$_member_i){$_member_val = &$this->_tpldata['member'][$_member_i]; if ($_member_val['S_PENDING']) {  ?>
		...
		<?php } else { if (!($_member_val['S_ROW_COUNT'] & 1)  ) {  ?><tr class="row1"><?php } else { ?><tr class="row2"><?php } ?>
			...
			<td><?php if ($_member_val['USERNAME_COLOUR']) {  ?><a href="<?php echo $_member_val['U_USER_EDIT']; ?>" style="color: #<?php echo $_member_val['USERNAME_COLOUR']; ?>;" class="username-coloured"><?php echo $_member_val['USERNAME']; ?></a><?php } else { ?><a href="<?php echo $_member_val['U_USER_EDIT']; ?>"><?php echo $_member_val['USERNAME']; ?></a><?php } ?></td>
