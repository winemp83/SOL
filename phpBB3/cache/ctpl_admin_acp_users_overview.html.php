<?php if (!defined('IN_PHPBB')) exit; ?><form id="user_overview" method="post" action="<?php echo (isset($this->_rootref['U_ACTION'])) ? $this->_rootref['U_ACTION'] : ''; ?>">
...
<dl>
	...
	<dd><input class="text medium" type="text" id="user_email" name="user_email" value="<?php echo (isset($this->_rootref['USER_EMAIL'])) ? $this->_rootref['USER_EMAIL'] : ''; ?>" autocomplete="off" /></dd>
</dl>
<dl>
