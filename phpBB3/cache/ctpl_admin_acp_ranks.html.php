...
<?php if ($this->_rootref['S_EDIT']) {  ?>
	...
	<dl>
		...
		<dd><label><input onclick="dE('posts', -1)" type="radio" class="radio" name="special_rank" value="1" id="special_rank"<?php if ($this->_rootref['S_SPECIAL_RANK']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label>
			<label><input onclick="dE('posts', 1)" type="radio" class="radio" name="special_rank" value="0"<?php if (! $this->_rootref['S_SPECIAL_RANK']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label></dd>
	</dl>
