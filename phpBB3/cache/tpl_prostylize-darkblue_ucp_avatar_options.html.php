<?php if (!defined('IN_PHPBB')) exit; ?><div class="panel">
	...
	<dl>
		...
		<dd><?php if ($this->_rootref['AVATAR']) {  echo (isset($this->_rootref['AVATAR'])) ? $this->_rootref['AVATAR'] : ''; } else { ?><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/no_avatar.png" alt="" /><?php } ?></dd>
