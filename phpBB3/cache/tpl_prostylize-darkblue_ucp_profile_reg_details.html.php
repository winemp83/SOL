...
<div class="panel">
	...
	<fieldset>
	<dl>
		<dt><label for="cur_password"><?php echo ((isset($this->_rootref['L_CURRENT_PASSWORD'])) ? $this->_rootref['L_CURRENT_PASSWORD'] : ((isset($user->lang['CURRENT_PASSWORD'])) ? $user->lang['CURRENT_PASSWORD'] : '{ CURRENT_PASSWORD }')); ?>:</label><br /><span><?php if ($this->_rootref['S_CHANGE_PASSWORD']) {  echo ((isset($this->_rootref['L_CURRENT_CHANGE_PASSWORD_EXPLAIN'])) ? $this->_rootref['L_CURRENT_CHANGE_PASSWORD_EXPLAIN'] : ((isset($user->lang['CURRENT_CHANGE_PASSWORD_EXPLAIN'])) ? $user->lang['CURRENT_CHANGE_PASSWORD_EXPLAIN'] : '{ CURRENT_CHANGE_PASSWORD_EXPLAIN }')); } else { echo ((isset($this->_rootref['L_CURRENT_PASSWORD_EXPLAIN'])) ? $this->_rootref['L_CURRENT_PASSWORD_EXPLAIN'] : ((isset($user->lang['CURRENT_PASSWORD_EXPLAIN'])) ? $user->lang['CURRENT_PASSWORD_EXPLAIN'] : '{ CURRENT_PASSWORD_EXPLAIN }')); } ?></span></dt>
