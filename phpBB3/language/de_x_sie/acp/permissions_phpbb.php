...
/**
*
* acp_permissions_phpbb (phpBB Permission Set) [Deutsch — Sie]
*
* @package language
...
$lang = array_merge($lang, array(
	...
	'acl_u_pm_img'		=> array('lang' => 'Kann [img]-BBCode-Tag in Privaten Nachrichten verwenden', 'cat' => 'pm'),
	'acl_u_pm_flash'	=> array('lang' => 'Kann [flash]-BBCode-Tag in Privaten Nachrichten verwenden', 'cat' => 'pm'),
...
$lang = array_merge($lang, array(
	...
	'acl_f_postcount'	=> array('lang' => 'Beitrags-Zähler wird erhöht<br /><em>Bitte beachten Sie, dass diese Einstellung nur für neue Beiträge greift.</em>', 'cat' => 'misc'),
