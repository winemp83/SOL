...
/**
*
* help_faq [Deutsch — Sie]
*
* @package language
* @version $Id: help_faq.php 593 2012-06-23 16:25:42Z philippk $
...
$help = array(
	...
	array(
		...
		1 => 'Wenn Sie sich sicher sind, dass Sie die Zeitzone und die Sommerzeit richtig eingestellt haben und die Zeit trotzdem noch falsch ist, geht die Uhr des Servers vermutlich falsch. Kontaktieren Sie einen Administrator, damit er das Problem beheben kann.'
		),
	array(
	...
	array(
		...
		1 => 'Die maximal zulässige Zahl von Antwortmöglichkeiten wird durch die Board-Administration festgelegt. Wenn Sie glauben, mehr Antwortmöglichkeiten als zugelassen zu benötigen, kontaktieren Sie einen Administrator.'
	),
	array(
	...
	array(
		...
		1 => 'Die Board-Administration kann bestimmte Dateitypen zulassen oder verbieten. Falls Sie sich nicht sicher sind, welche Dateitypen Sie hochladen können und Sie Unterstützung benötigen, wenden Sie sich bitte an die Board-Administration.'
	),
	array(
	...
	array(
		...
		1 => 'Diese Software wurde von der phpBB Group geschrieben. Wenn Sie denken, dass eine Funktion implementiert werden muss oder Sie einen Fehler melden wollen, dann besuchen Sie die <a href="http://area51.phpbb.com/">Area51-Website von phpbb.com</a>, wo Sie die notwendigen Werkzeuge dafür finden.'
	),
	array(
