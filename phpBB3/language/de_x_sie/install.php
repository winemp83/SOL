...
*
* @package language
* @version $Id: install.php 593 2012-06-23 16:25:42Z philippk $
...
$lang = array_merge($lang, array(
	...
	'DEFAULT_PREFIX_IS'			=> 'Der Konverter konnte keine Tabellen mit dem angegebenen Präfix finden. Bitte stellen Sie sicher, dass Sie die richtigen Daten des Boards angegeben haben, von dem Sie konvertieren wollen. Der standardmäßige Tabellenpräfix für %1$s ist <strong>%2$s</strong>.',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		<p>Sie haben phpBB %1$s erfolgreich installiert. Bitte fahren Sie mit einer der folgenden Optionen fort:</p>
		<h2>Ein bestehendes Board auf phpBB3 konvertieren</h2>
		<p>Das phpBB-Konvertierungs-System unterstützt die Konvertierung von phpBB 2.0.x und anderen Board-Systemen auf phpBB3. Wenn Sie ein bestehendes Board konvertieren wollen, fahren Sie bitte <a href="%2$s">mit dem Konverter fort</a>.</p>
	...
	'INSTALL_NEXT_PASS'			=> 'Alle Voraussetzungen wurden erfolgreich geprüft und Sie können nun mit dem nächsten Schritt der Installation weitermachen. Sollten Sie Befugnisse, Module o.&nbsp;ä. geändert haben und einen erneuten Testdurchlauf wünschen, so können Sie den Test wiederholen.',
	...
	'INST_ERR_PREFIX'			=> 'Es existieren bereits Tabellen mit dem angegebenen Präfix, bitte wählen Sie einen alternativen.',
...
$lang = array_merge($lang, array(
	...
	'FILES_NEW_EXPLAIN'				=> 'Gegenwärtig fehlen die folgenden Dateien in Ihrer Installation. Sie werden dieser hinzugefügt.',
	...
	'FILES_NOT_MODIFIED_EXPLAIN'	=> 'Die folgenden Dateien sind nicht geändert und entsprechen den originalen phpBB-Dateien der Version, von der aus Sie updaten wollen.',
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<ul style="margin-left: 20px; font-size: 1.1em;">
			<li>Gehen Sie zur <a href="http://www.phpbb.com/downloads/" title="http://www.phpbb.com/downloads/">phpBB.com-Downloadseite</a> und laden Sie das entsprechende „Automatisches-Update-Paket“ herunter (<a href="http://www.phpbb.de/go/3/downloads">deutschsprachige Downloadseite</a>).<br /><br /></li>
